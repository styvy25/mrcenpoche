...
const AmazonBooksAd: React.FC<AmazonBooksAdProps> = ({ className = "", compact = false }) => {
      ...
      <div className={`grid ${compact ? "grid-cols-1" : "grid-cols-1 sm:grid-cols-3"} gap-2`}>
        {books.map((book, index) => (
          <motion.a
            ...
            className="block p-2 bg-gray-800/40 hover:bg-gray-800/60 rounded-lg transition-all duration-300 border border-white/10 overflow-hidden group"
          ...
          >
            <div className="relative flex flex-col h-full">
              {book.imageUrl ? (
                ...
                <div className="w-full aspect-[3/4] mb-2 overflow-hidden rounded-md bg-gradient-to-r from-blue-900 to-purple-900 flex items-center justify-center">
