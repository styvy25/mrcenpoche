...
const ChatInput = memo(({
  ...
  return <div className="p-4 border-t border-white/10 backdrop-blur-lg bg-sky-300">
      <form onSubmit={handleSubmit} className="flex gap-2">
        ...
        <Button type="button" variant="outline" onClick={onGeneratePDF} title="Générer un PDF" disabled={isLoading} className="border-white/20 h-11 w-11 p-0 flex items-center justify-center bg-cyan-50">
          <Download size={18} />
        </Button>
      </form>
    </div>;
