...
export function Menu({
  ...
  return <div className="relative inline-block text-left" ref={menuRef}>
      ...
      {isOpen && <div className={`absolute ${align === "right" ? "right-0" : "left-0"} mt-2 w-56 rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black dark:ring-gray-700 ring-opacity-9 focus:outline-none z-50`} role="menu" aria-orientation="vertical" aria-labelledby="menu-button">
...
export function MenuItem({
  ...
  return <button className={`relative block w-full h-16 text-center group
      ...
      <span className="flex items-center justify-center h-full mt-[1%] px-0 text-left font-normal my-0 py-[13px] mx-0">
        {icon && <span className="h-6 w-6 transition-all duration-200 group-hover:[&_svg]:stroke-[2.5]">
            {icon}
          </span>}
        {children}
      </span>
